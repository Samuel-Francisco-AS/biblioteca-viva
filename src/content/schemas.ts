...
export const contentCatalogSchema = z.strictObject({
  ...
  fallbacks: z.strictObject({
    ...
    "researcher.interaction": stableIdSchema,
    "projectionist.interaction": stableIdSchema,
    "training-keeper.interaction": stableIdSchema,
    "scribe.interaction": stableIdSchema,
  }),
