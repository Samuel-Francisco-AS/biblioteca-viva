...
BF-2 ⏳ EM ANDAMENTO
  ...
  BF-2B ⏳ NÃO INICIADA
PRÓXIMO AUTORIZÁVEL: planejamento e implementação autorizada da BF-2B; nenhuma integração automática ao runtime
```
