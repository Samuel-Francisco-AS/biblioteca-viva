...
A correção dirigida após auditoria independente acrescentou prova de picking por canvas BF-2 no snapshot composto: livro visível em cada uma das três estantes e as três estantes, com interseções reais, identidade, `entryId` e destaque. Não se demonstrou interferência dos wrappers BF-3 nesses pontos; produção e prioridade de picking permaneceram intactas. A CI remota de 78 arquivos/622 testes e 17 E2E pertence ao HEAD anterior `214c6c6`; a prova nova tem gate local proporcional.
