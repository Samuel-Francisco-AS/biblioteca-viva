...
| R-08 | escopo crescer antes de uma fatia aprovada | roadmap progressivo, STATUS e ADR-009 limitam a aprovação ao renderer da Fundação; F3 concluiu câmera/interação e F4–F6 continuam exigindo escopo próprio |
| R-09 | desempenho 3D em Android modesto | **parcialmente mitigado:** a validação humana ampla da F3 observou aproximadamente 60 FPS ou próximo na fixture durante interação e rotação, sem regressão perceptível; F4 poderá produzir evidência controlada de custo individual de asset, mas não mitiga densidade, assets combinados, iluminação, personagens ou mundo real — aprofundamento permanece em F5 |
