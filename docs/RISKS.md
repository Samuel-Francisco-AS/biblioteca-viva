...
| R-08 | escopo crescer antes de uma fatia aprovada | roadmap progressivo, STATUS e ADR-009 limitam a aprovação ao renderer da Fundação; F4 fechou somente contrato experimental de assets, F5 e F6 estão concluídas e P3D-B segue em escopo próprio, ainda sem mundo real, persistência espacial ou promoção antecipada |
