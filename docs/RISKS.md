...
| R-09 | desempenho 3D em Android modesto | **parcialmente mitigado:** F5-B mediu no Moto G06 a escada F1/F4/F4×4, loading, memória, remounts, interação, orientação, background/resume e sessão de aproximadamente 15 minutos sem crash, degradação humana percebida ou thermal status acima de `0`; não mitiga densidade/conteúdo real, iluminação, personagens, memória GPU exata ou mundo final — budgets e interpretação permanecem em F5-C |
