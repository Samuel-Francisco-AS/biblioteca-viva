...
- a fronteira semântica sobrevivente é `React semântico ↔ estado efêmero ↔ ThreeWorldRuntime → Three.js`; F6 concluiu esse contrato tecnicamente, sem declarar TalkBack ou acessibilidade humana Android aprovados;
